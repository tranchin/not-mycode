...
export class PQMessageCodec {
	decodePQMessage(encoded: Uint8Array): PQMessage {
	...
	encodePQMessage({ protocolVersion, senderIdentityPubKey, ephemeralPubKey, encapsulation }: PQMessage): Uint8Array {
