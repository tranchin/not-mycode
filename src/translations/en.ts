export default {
	...
	"keys": {
		...
		"customerUsageDataOptOut_label": "Global usage data opt-out",
		"customerUsageDataOptOutInfo_msg": "Overrides all of this account's users' usage test opt-in decisions. If activated, then the users' opt-in decisions have no effect and usage data is never collected.",
		...
		"userUsageDataOptIn_label": "Usage data opt-in",
