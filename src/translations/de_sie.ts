export default {
	...
	"keys": {
		...
		"newPlansOfferExplanation_msg": "Wechseln Sie jetzt, und profitieren Sie von unserem exclusiven Einführungsangebot: Buchen Sie jährlich, und bekommen Sie das zweite Jahr umsonst dazu. Mit diesem einmaligen Angebot sparen Sie 50% auf alle Tutanota Pläne!!! 🥳",
