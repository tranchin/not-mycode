...
export function renderGiftCard(value: number, message: string): Children {
	...
	return [
		...
		m("", renderGiftCardSvg(parseInt(value))), // TODO Center the gift card somehow
	]
}

export function renderGiftCardLinks(link: string): Children {
