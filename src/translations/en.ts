export default {
	...
	"keys": {
		...
		"creditUsageOptions_msg": "Credit can be used to switch plans (go to 'Settings' ⇨ 'Plan' once logged in), or can be held on to until the next subscription period to pay for a renewal. Credit created from gift cards does not expire!",
		...
		"insufficientStorageAdmin_msg": "Your storage limit has been exceeded. You can no longer receive or send emails. Please free some memory by deleting content of your mailbox or upgrade to a larger plan.",
		"insufficientStorageWarning_msg": "Your mailbox has nearly reached the storage limit. Please free some memory by deleting content of your mailbox or upgrade to a larger plan.",
