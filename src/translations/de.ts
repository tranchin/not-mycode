export default {
	...
	"keys": {
		...
		"pricing.perUserMonthPaidYearly_label": "pro User/Monat - jährliche Zahlung",
		"pricing.perUserMonth_label": "pro User/Monat",
		...
		"newPaidPlanRequired_msg": "Um diese Funktion zu benutzen, musst Du auf eines der folgenden Abonnements wechseln.",
		"moreCustomDomainsRequired_msg": "Um weitere eigene Domains hinzuzufügen, musst Du auf eines der folgenden Abonnements wechseln.",
		"moreAliasesRequired_msg":  "Um weitere email To add E-Mail-Aliasse hinzuzufügen, musst Du auf eines der folgenden Abonnements wechseln.",
		...
		"giftCardUpgradeNotifyRevolutionary_msg": "Dein Account wird automatisch auf einen Revolutionary-Account mit einem jährlichen Abonnement umgestellt.",
		...
		"bonus_label": "Bonus",
		"switchSubscriptionInfo_msg": "Ein neuer Abrechnungszeitraum beginnt, wenn Du zu einem anderen Abonnement wechselst. Du erhältst eine Gutschrift für die verbliebenen Monate des aktuellen Abonnements.",
