...
export function renderGiftCard(giftCard: GiftCard): Promise<Children> {
	...
	return generateGiftCardLink(giftCard).then(link => {
		...
		return m(".flex-v-center.highlighted", [
			m("", {
				style: {
					padding: px(size.vpad_large)
				}
			}, m.trust(giftCardSvg)),
